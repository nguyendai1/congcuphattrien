...
//	    	// Tìm và nhấp vào nút tăng số lượng sản phẩm trong giỏ hàng
//	        WebElement increaseButton = driver.findElement(By.xpath("//input[@id='quantity-0']"));
//	        increaseButton.click();

//	        // Kiểm tra số lượng sản phẩm đã tăng lên
//	        WebElement quantityElement = driver.findElement(By.xpath("//input[@id='quantity-0']"));
////	        quantityElement.sendKeys(Keys.chord(Keys.CONTROL, "a"));
