...
//        driver.quit();
    ...
    public static void main(String[] args) {
    	themdiachi Themdiachi = new themdiachi();
    	Themdiachi.login("adminaccount","Adminaccount1");
    	Themdiachi.ProductPage();
    	Themdiachi.addProduct(2);
    	Themdiachi.thanhtoan();
    	Themdiachi.tearDown();
